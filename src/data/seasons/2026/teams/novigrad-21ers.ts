      ...
      items: [
        {
          ...
          secondary: '2481 fantasy points',
          meta: '#1'
        },
        {
          primary: 'Deni Avdija',
          secondary: '1965 fantasy points',
          meta: '#2'
        },
        {
          primary: 'Cooper Flagg',
          secondary: '1875 fantasy points',
          meta: '#3'
        }
      ],
